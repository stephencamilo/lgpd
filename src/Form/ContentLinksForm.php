...
class ContentLinksForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'lgpd_content_links_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->hasValue('links')) {
      ...
      $config = $this->configFactory->getEditable(static::lgpd_CONTENT_CONF_KEY);
      $config
        ->set('links', $links)
        ->save();
    }
  ...
  protected function loadUrls() {
    $config = $this->config(static::lgpd_CONTENT_CONF_KEY)->get('links');
