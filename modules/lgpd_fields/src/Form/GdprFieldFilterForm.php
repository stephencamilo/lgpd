...
/**
 * Filter form for lgpd field list page.
 *
...
class lgpdFieldFilterForm extends FormBase {
  ...
  public function getFormId() {
    return 'lgpd_fields_field_filter_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['container']['rta'] = [
      ...
      '#options' => ['0' => 'Not configured'] + lgpdField::rtaOptions(),
      '#multiple' => TRUE,
    ...
    $form['container']['rtf'] = [
      ...
      '#options' => ['0' => 'Not configured'] + lgpdField::rtfOptions(),
      '#multiple' => TRUE,
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('lgpd_fields.fields_list', [], ['query' => $arguments]);
  }
  ...
  /**
   * Gets lgpd field filters from the request.
   *
