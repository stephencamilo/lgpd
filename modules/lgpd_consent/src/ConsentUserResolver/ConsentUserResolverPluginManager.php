...
class ConsentUserResolverPluginManager extends DefaultPluginManager {
  ...
  public function __construct(
    ...
    parent::__construct(
      'Plugin/lgpd/ConsentUserResolver',
      $namespaces,
      $moduleHandler,
      lgpdConsentUserResolverInterface::class,
      lgpdConsentUserResolver::class
    );

    $this->setCacheBackend($cacheBackend, 'lgpd_consent_resolver_plugins');
    $this->alterInfo('lgpd_consent_resolver_info');
  }
