 ...
 *
 * @ContentEntityType(
 *   id = "lgpd_consent_agreement",
 *   label = @Translation("Consent Agreement"),
 *   description = @Translation("Consent Agreement"),
 *   base_table = "lgpd_consent_agreement",
 *   data_table = "lgpd_consent_agreement_field_data",
 *   revision_table = "lgpd_consent_agreement_revision",
 *   translatable = TRUE,
 *   handlers = {
 *     "storage" = "Drupal\lgpd_consent\ConsentAgreementStorage",
 *     "list_builder" = "Drupal\lgpd_consent\Entity\ConsentAgreementListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "route_provider" = {
 *       "html" = "Drupal\lgpd_consent\ConsentAgreementHtmlRouteProvider"
 *     },
 *     "form" = {
 *       "default" = "Drupal\lgpd_consent\Form\ConsentAgreementForm",
 *       "add" = "Drupal\lgpd_consent\Form\ConsentAgreementForm",
 *       "edit" = "Drupal\lgpd_consent\Form\ConsentAgreementForm",
 ...
 *   },
 *   admin_permission = "manage lgpd agreements",
 *   links = {
 *     "canonical" = "/admin/lgpd/agreements/{lgpd_consent_agreement}",
 *     "add-form" = "/admin/lgpd/agreements/add",
 *     "edit-form" = "/admin/lgpd/agreements/{lgpd_consent_agreement}/edit",
 *     "delete-form" = "/admin/lgpd/agreements/{lgpd_consent_agreement}/delete",
 *     "version-history" = "/admin/lgpd/agreements/{lgpd_consent_agreement}/revisions",
 *     "revision" = "/admin/lgpd/agreements/{lgpd_consent_agreement}/revisions/{lgpd_consent_agreement_revision}/view",
 *     "revision_revert" = "/admin/lgpd/agreements/{lgpd_consent_agreement}/revisions/{lgpd_consent_agreement_revision}/revert",
 *     "revision_delete" = "/admin/lgpd/agreements/{lgpd_consent_agreement}/revisions/{lgpd_consent_agreement_revision}/delete",
 *     "collection" = "/admin/lgpd/agreements",
 *   },
 * )
 */
