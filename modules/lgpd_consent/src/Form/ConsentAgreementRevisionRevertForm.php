...
class ConsentAgreementRevisionRevertForm extends ConfirmFormBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity_type.manager')->getStorage('lgpd_consent_agreement'),
  ...
  public function getFormId() {
    return 'lgpd_consent_agreement_revision_revert_confirm';
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.lgpd_consent_agreement.version_history', ['lgpd_consent_agreement' => $this->revision->id()]);
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $lgpd_consent_agreement_revision = NULL) {
    $this->revision = $this->consentAgreementStorage->loadRevision($lgpd_consent_agreement_revision);
