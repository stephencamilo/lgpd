...
namespace Drupal\lgpd_consent\Plugin\Block;
...
use Drupal\lgpd_consent\Controller\ConsentAgreementController;
 ...
 *
 * @Block(
 *   id = "lgpd_agreements_block",
 *   admin_label = @Translation("lgpd Agreements Accepted"),
