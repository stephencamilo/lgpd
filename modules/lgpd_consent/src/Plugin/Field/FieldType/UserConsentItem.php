...
/**
 * Plugin implementation of the 'lgpd_user_consent' field type.
 *
 * @FieldType(
 *   id = "lgpd_user_consent",
 ...
 *   default_widget = "lgpd_consent_widget",
 *   default_formatter = "lgpd_consent_formatter"
 * )
 */
class UserConsentItem extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $agreement_ids = \Drupal::entityQuery('lgpd_consent_agreement')
      ->condition('status', 1)
      ->sort('title')
      ->execute();
