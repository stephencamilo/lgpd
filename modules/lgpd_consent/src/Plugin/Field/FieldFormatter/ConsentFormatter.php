...
namespace Drupal\lgpd_consent\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the lgpd_consent_formatter formatter.
 *
 * @FieldFormatter(
 *   id = "lgpd_consent_formatter",
 *   label = @Translation("lgpd Consent Formatter"),
 *   field_types = {
 *    "lgpd_user_consent"
 *   }
 * )
