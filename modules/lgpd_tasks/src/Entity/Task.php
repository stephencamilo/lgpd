 ...
 *     "list_builder" = "Drupal\lgpd_tasks\TaskListBuilder",
 *     "views_data" = "Drupal\lgpd_tasks\Entity\TaskViewsData",
 *     "form" = {
 *       "default" = "Drupal\lgpd_tasks\Form\TaskForm",
 *       "process" = "Drupal\lgpd_tasks\Form\TaskActionsForm",
 *       "delete" = "Drupal\lgpd_tasks\Form\TaskDeleteForm",
 *     },
 *     "access" = "Drupal\lgpd_tasks\TaskAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\entity\Routing\AdminHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "lgpd_task",
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/lgpd/tasks/{lgpd_task}",
 *     "delete-form" = "/admin/lgpd/tasks/{lgpd_task}/delete",
 *     "collection" = "/admin/lgpd/tasks",
 *   },
 *   bundle_entity_type = "lgpd_task_type",
 *   field_ui_base_route = "entity.lgpd_task_type.edit_form"
 * )
 */
